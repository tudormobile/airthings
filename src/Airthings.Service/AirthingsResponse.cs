...
internal static class AirthingsResponse
{
    /// <summary>
    /// Creates a successful Airthings response containing the specified value.
    /// </summary>
    /// <param name="value">The value to include in the response data.</param>
    /// <returns>A new <see cref="AirthingsResponse{T}"/> instance with the specified value set as data and the success flag set to true.</returns>
    public static AirthingsResponse<T> Success<T>(T value) => new() { Data = value, IsSuccess = true };
    /// <summary>
    ...
    /// <returns>A new <see cref="AirthingsResponse{T}"/> instance with Success set to false and Data set to the specified value.</returns>
    public static AirthingsResponse<T> Failure<T>(T value) => new() { Data = value, IsSuccess = false };
}
