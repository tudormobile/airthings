...
- `Airthings.IntegrationTests` - Integrations tests for the library package  
...
- `Tudormobile.Airthings.Service.1.0.0.nupkg`
    - Service library to expose the Airthings sensor data.
    - Create local services that access sensor data. 
