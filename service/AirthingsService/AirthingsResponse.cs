...
internal static class AirthingsResponse
{
    ...
    /// <returns>A new AirthingsResponse<T> instance with the specified value set as data and the success flag set to true.</returns>
    ...
    /// <returns>A new AirthingsResponse<T> instance with Success set to false and Data set to the specified value.</returns>
